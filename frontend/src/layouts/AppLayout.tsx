          ...
          <div className="brand">
            <div className="brand__mark">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M6.5 18C4.01 18 2 15.99 2 13.5C2 11.27 3.61 9.42 5.74 9.06C6.38 6.75 8.49 5 11 5C13.97 5 16.4 7.22 16.49 10.04C18.47 10.3 20 12.01 20 14C20 16.21 18.21 18 16 18H6.5Z" fill="#ebf0fb"/>
              </svg>
            </div>
            <div>
